...
```shell
numary exec dunshire first.num
```

And we can visit [the Numary dashboard](https://control.numary.com/accounts/player:benwyatt) to verify the transaction:
...
:::caution
Accounts in Numary Ledger cannot go negative! (Except for the special `@world` account).
:::

Transactions described in Numscript are **not** idempotent! Executing the same transaction twice tells Numary Ledger to make two distinct transfers.

## Congratulations

You've now seen the basics of Numary Ledger, and you can:

* Start the Numary Ledger service on your local computer
...
But Numary Ledger is capable of so much more. To continue learning about all the things Numary Ledger can do, we're prepared [a series of guides](/oss/ledger/guides/), each building upon what you've learned here, and each covering a specific topic.