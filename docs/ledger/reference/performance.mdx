...
In the architecting for scale [section](../guides/scale.mdx), we outline different strategies to handle a growing volume of ledger data, with a focus on efficient usage of multiple ledgers.
