...
Numscript supports several variable types. Details on the different types and how they are used [are available in the Numscript reference docs](../../../numscript/variables.mdx).
...
:::tip Dig deeper
Want to learn more about creating Numscript templates? [The Numscript reference docs](../../../numscript/variables.mdx) have you covered!
:::
