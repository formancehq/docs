...
But Formance Ledger is capable of so much more. To continue learning about all the things Formance Ledger can do, we're prepared a set of [guides to Numscript](../../numscript/index.mdx), each building upon what you've learned here, and each covering a specific topic.
