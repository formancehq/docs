...
We also provide Docker images for production environments. You can learn more about all the different ways of installing Formance Ledger in the [reference documentation](/ledger/operations/installation).
