...
Formance Ledger can also be used and installed as a standalone component without the whole Formance Stack. You can find more details about installing it this way the ledger [installation reference](/ledger/operations/installation).
