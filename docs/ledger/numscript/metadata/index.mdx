...
You can store the value of [template variables](/ledger/numscript/templates/) in metadata as well. Template variables may only be of `monetary`, `account`, or `portion` types, and must be specified like the following examples:
