...
If you recall from the [Getting Started](../../get-started/hello-world/index.mdx) section, we learned how to run this Numscript from the command line. In a file called `first.num` we had:
...
:::tip Dig deeper
Want to learn more about the Formance Ledger API? The [guide to the Formance Ledger API](../../api/index.mdx) has you covered!
:::
