...
In Numscript, a [posting](../reference/transactions.md#postings) models the movement of an amount of an asset from one account to another. Postings are wrapped in a [transaction](../reference/transactions.md#transactions-1) to ensure that they are applied atomically.
