...
Wallets is a fully managed, white-label wallet service to materialize and spend users funds, with built-in support for multi-currency balances, reserved funds, temporary holds and fungibles expirations capabilities. It is built on top of the Formance Ledger service and is designed to provide an easy way to get started with adding wallets capabilities to your application without having to worry about the underlying transactions structure, by providing an opinionated model implementation.
