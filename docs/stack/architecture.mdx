...
The Formance Platform is available in two editions: the MIT and the Enterprise Edition (EE). The CE is open-source and free to use, while the EE is a commercial offering that includes additional features and support.
