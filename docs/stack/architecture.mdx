...
The Formance Platform is available in two editions: the MIT and the Enterprise Edition (EE). The Community Edition is open-source and free to use, while the Enterprise Edition is a commercial offering that includes additional features and support.

> For information about the EE licence, please refer to the [Licence](/deployment/licence) documentation.
...
|-------------------|-----------------------------------------------------------|------------------|------------------|---------|
| Console           | Administration user interface                             | Proprietary (EE) | Not available    | Server  |
| Portal            | Administration user interface                             | Proprietary (EE) | Not available    | Server  |
| Membership        | Internal Formance Cloud API                               | Proprietary (EE) | Not available    | Server  |
