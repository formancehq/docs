...
| HTTP Method  | Status Code | Host        | Endpoint                     | Request Headers        | Response Headers       | Response Body         |
|--------------|-------------|-------------|------------------------------|------------------------|------------------------|-----------------------|
| The method used (e.g., GET, POST) | The response status code (e.g., 200) | The host of the request | The API endpoint accessed | Headers included in the request | Headers included in the response | Content of the response body |
