...
<DocCard headline="Ledger to Payout" cta="Learn More" link="examples/stripe-payout" highlight="true">
  Learn how to initate a Stripe Connect transfer, sourcing funds from a Formance ledger account.
</DocCard>

<DocCard headline="Deposit on Wallet" cta="Learn More" link="examples/payment-to-wallet" highlight="true">
  Learn how to automate the deposit of funds on a user wallet once a payment is received.
</DocCard>

<DocCard headline="Multiple Ledgers" cta="Learn More" link="examples/ledger-to-ledger" highlight="true">
