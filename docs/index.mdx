...
<DocCard headline="Wallets (beta)" icon="/img/module-wallets.svg" cta="Learn More" link="wallets/" highlight="true" tag="beta">
...
<DocCard headline="Flows (beta)" icon="/img/module-flows.svg" cta="Learn More" link="flows/" highlight="true" tag="beta">
