...
<DocCard headline="Numscript" cta="Learn More" link="/ledger/reference/numscript/machine/" highlight="true">
...
<DocCard headline="Wallets (beta)" cta="Learn More" link="/wallets/" highlight="true" tag="beta">
