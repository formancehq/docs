...
The database migrations are handled automoatically by the Formance Kubernetes Operator. This applies for all the services that are deployed by the operator.
