...
:::warning
This guide assume that you have already installed the Formance Operator on your cluster. If you haven't done so, please refer to the [installation guide](../installation/deployments.mdx) before proceeding.
:::
...
Your demo environment is now ready for use. You can now move on to the [configuration](/docs/configuration) of your environment.