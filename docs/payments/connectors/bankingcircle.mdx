...
```shell
fctl payments connectors install bankingcircle bankingcircle.json
```
...
-d @bankingcircle.json
```

</StackCmd>

with bankingcircle.json containing:
...
```json
{
    ...
    "userCertificateKey": "<certificate key>",
    "pollingPeriod": "2m"
}
```