...
<DocCard headline="Concepts" cta="Learn Concepts" link="payments-concepts" highlight="true">
    Learn the core concepts you need to know to use the Connectivity service.
</DocCard>

<DocCard headline="Connectors" cta="Install Connectors" link="connectors/" highlight="true">
    Install the Formance connector for your financial service provider.
</DocCard>

<DocCard headline="Framework" cta="Build a Connector" link="connectors/framework" highlight="true">
