...
A payment is composed of several key elements. Firstly, there is an ID internal to formance. This ID is used to identify the payment within the formance payments service and to perform various actions
related to it.
...
On the Formance Console, you have access to a comprehensive list of payments. To view this list, simply navigate to the Payments tab located on the left side of the screen. By doing so, you will be
