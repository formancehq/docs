...
Before you can link your Kubernetes cluster to a private Formance region. You must deploy [the Operator following this documentation](/next/operator/Installation).
