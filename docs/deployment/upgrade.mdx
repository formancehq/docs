...
The operator can be upgraded with Helm, following the instructions in the dedicated operator upgrade [section](../operator/upgrade/operator.mdx).
...
You can find the latest assemblage of components versions in the stack versions [section](../stack/versions.mdx).
