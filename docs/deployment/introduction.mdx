...
With a modular and cloud-native architecture, the Formance Platform is designed to be deployed in a variety of ways depending on your requirements, ranging from fully managed to fully self-hosted. More details on the platform architecture can be found in the [Architecture](/stack/architecture.mdx) section.
...
Specifics of the Formance Cloud deployment are detailed in the [Formance Cloud](/deployment/cloud/intro.mdx) section.
...
Specifics of the CloudPrem (Tier I) deployment are detailed in the [CloudPrem](/deployment/cloudprem/private-regions.mdx) section.
...
Specifics of the Formance Elements deployment are detailed in the [Formance Elements](/next/operator/installation/deployments) section.
