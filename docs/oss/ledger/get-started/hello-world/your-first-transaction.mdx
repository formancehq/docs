...
And we can visit [the Formance dashboard](https://control.formance.com/accounts/player:benwyatt) to verify the transaction:
...
Transactions described in Numscript are **not** idempotent! Executing the same transaction twice tells Formance Ledger to make two distinct transfers.

## Congratulations

You've now seen the basics of Formance Ledger, and you can:

* Start the Formance Ledger service on your local computer
...
But Formance Ledger is capable of so much more. To continue learning about all the things Formance Ledger can do, we're prepared a set of [guides to Numscript](/oss/ledger/numscript/), each building upon what you've learned here, and each covering a specific topic.