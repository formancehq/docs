...
In Numscript, a [posting](../../ledger/reference/transactions.md#postings) models the movement of an amount of an asset from one account to another. Postings are wrapped in a [transaction](../../ledger/reference/transactions.md#transactions-1) to ensure that they are applied atomically.
