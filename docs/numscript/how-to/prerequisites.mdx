...
If you find that you want a clean slate to start from, you can reset the Dunshire ledger in its entirety. If you followed the [Hello World tutorial](../../ledger/get-started/hello-world/index.mdx).
