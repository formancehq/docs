...
:::caution
This deployment method is being deprecated in favor of the [operator-based](/v1.10/deployment/cloudprem/intro) deployment. The charts below will continue to be available for the time being, but will not be updated with new features.
:::
