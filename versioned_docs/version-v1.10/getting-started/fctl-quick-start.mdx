...
:::info
The Formance Platform embraces a CloudPrem architecture — enabling you to decide how much you want to run on your own infrastructure, and how much you want to run on Formance Cloud. More details can be found in the architecture [section](/v1.10/stack/architecture).
:::
