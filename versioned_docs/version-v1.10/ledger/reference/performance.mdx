...
In the architecting for scale [section](/v1.10/ledger/advanced/scale), we outline different strategies to handle a growing volume of ledger data, with a focus on efficient usage of multiple ledgers.
