...
:::info
Variables can also be pulled from account metadata, as per described in the [metadata](/v1.10/ledger/reference/numscript/metadata) section in the next page.
:::
