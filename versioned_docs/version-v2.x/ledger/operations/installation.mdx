...
:::info
For historical reasons, the Formance Ledger packages and binaries are named `ledger`. This name will change in the future, though the `ledger` command will remain available for backwards compatibility.
:::
